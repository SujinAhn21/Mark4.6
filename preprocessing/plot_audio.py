...
def plot_waveform_and_mel(path, save_dir=None, seed_value=42, mark_version="mark4.6"):  # change needed
    set_seed(seed_value)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mark_version', type=str, default="mark4.6")
